...
$(function(){
	$("..user-phone span").each(function() {
	var maxwidth =5;//显示多少字符
...
$(function(){
	...
	$(".nav ul li a").click(function(event) {
		$(".wap-menu").removeClass('acti');
		$(".nav").removeClass('active');
	});
	$(".psl-center").click(function(event) {
		$(".drop-box2").toggle();
		$("body").addClass('sx');
		event.stopPropagation();
	});
	$(".psl-center .drop-box a").click(function(event) {
		$(".drop-box").fadeOut();
		event.stopPropagation();
	});
	$("body").click(function(event) {
	...
	if($("body").width() >=750){
		var i_height = $(".content-box").height();
		var s_height = $(".sidebar-box").height();
		if(i_height > 1280){
			$(".sidebar-box").height(i_height)
		}else{
		}
		if(i_height < 1280){
			$(".content-box .big-box:first").height(s_height - 70)
		}else{
		}
	}
	$(".tabs-vip").click(function(event) {
		if($("body").width() >=750){
			var i_height = $(".content-box").height();
			var s_height = $(".sidebar-box").height();
			if(i_height > 1280){
	...
	$(".trou-log table tr td em").click(function(event) {
		$(this).parents("tr").remove();
	});
	$(".all_remove").click(function(event) {
		$(".trou-log table tr:not(:first)").remove();
	});
	
	
})
addClass(".sidebar-box .box ul li","acti","");
